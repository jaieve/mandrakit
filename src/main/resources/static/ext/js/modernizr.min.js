window.Modernizr = function (e, t, n) {
    ...
    var d,
        ...
        A = function () {
            function e(e, o) {
                ...
                return i || (
                    ...
                    o.setAttribute && o.removeAttribute && (
                        o.setAttribute(e, ""),
                        i = a(o[e], "function"),
        ...
        L = {}.hasOwnProperty;
    f = a(L, "undefined") || a(L.call, "undefined")
        ? function (e, t) {
    ...
    M.touch = function () {
        ...
        return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch
            ? n = !0
            : F(
                ["@media (", S.join("touch-enabled),("), v, ")", "{#modernizr{top:9px;position:absolute}}"].join(""),
                function (e) {
                    n = 9 === e.offsetTop
                }
            ),
    ...
    M.cssgradients = function () {
        ...
        return r(
            (e + "-webkit- ".split(" ").join(t + e) + S.join(n + e)).slice(0, -e.length)
        ),
    ...
    M.smil = function () {
        return !!t.createElementNS && /SVGAnimate/.test(
            w.call(t.createElementNS(N.svg, "animate"))
        )
    },
    M.svgclippaths = function () {
        return !!t.createElementNS && /SVGClipPath/.test(
            w.call(t.createElementNS(N.svg, "clipPath"))
        )
    };
    for (var H in M) 
        f(M, H) && (d = H.toLowerCase(), p[d] = M[H](), $.push((
            p[d]
                ? ""
                : "no-"
        ) + d));
    ...
    p.addTest = function (e, t) {
        ...
        t = "function" == typeof t
                ? t()
                : t,
            "undefined" != typeof h && h && (g.className += " " + (
                t
                    ? ""
                    : "no-"
            ) + e),
    ...
    function (e, t) {
        ...
        function c(e, t) {
            ...
            e.createElement = function (n) {
                return y.shivMethods
                    ? a(n, e, t)
                    : t.createElem(n)
            },
            e.createDocumentFragment = Function(
                "h,f",
                "return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" + r().join().replace(/[\w\-]+/g, function (e) {
        ...
        function s(e) {
            e || (e = t);
            var r = o(e);
            return !y.shivCSS || u || r.hasCSS || (r.hasCSS = !!n(
                e,
        ...
        var y = {
            elements: f.elements || "abbr article aside audio bdi canvas data datalist details dialog figcaption fi" +
