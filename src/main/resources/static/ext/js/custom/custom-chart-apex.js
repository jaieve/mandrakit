...
$(document).ready(function() {
    ...
    var options = {
      ...
      var chart = new ApexCharts(document.querySelector("#apex-column-chart-day"), options);
      chart.render();
    /* -- Month -- */
    var options = {
      series: [{
    ...
    var chart = new ApexCharts(document.querySelector("#apex-column-chart-month"), options);
    chart.render();
       /* -- Status -- */
       var options = {
        series: [{
      ...
      var chart = new ApexCharts(document.querySelector("#apex-column-chart-status"), options);
      chart.render();
